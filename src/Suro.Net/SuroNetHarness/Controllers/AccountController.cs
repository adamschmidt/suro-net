...
using SuroNetHarness.Filters;
using SuroNetHarness.Models;
using Suro.Net.Web;

namespace SuroNetHarness.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        public JsonResult JsonLogin(LoginModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    SuroContext.Current.Add("todo_login_fail", model);
        ...
        public ActionResult JsonRegister(RegisterModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    SuroContext.Current.Add("todo_registration", model);
